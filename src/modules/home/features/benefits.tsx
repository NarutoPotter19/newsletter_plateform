...
// const Benefits = () => {
//   return (
//     <div className=" benefit-cover min-h-[60vh] relative flex item-center justify-center ">
//         <div className="w-[70%] md:h-[350px] bg-[#7F5FF] border-[2px] rounded border-blue-500 p-2">
