  ...
  return (
    <div className="border-t border-b border-[#000] py-10">
      <h3 className="uppercase text-xl md:text-2xl text-center max-w-3xl mx-auto font -[400] z-20 relative">
        Created by Early Morning Shivankit Team

      </h3>
<div className="w-full text-center pt-1">
  <h3 className="upperccase bg-[#F091DD] rounded p-2 text-xl md:text-2xl text center inline-block font-[400]">
Now Powering The Worlds Best Newsletters
  </h3>
